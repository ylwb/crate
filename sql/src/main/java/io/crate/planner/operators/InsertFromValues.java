...
public class InsertFromValues implements LogicalPlan {
    ...
    private <TReq extends ShardRequest<TReq, TItem>, TItem extends ShardRequest.Item> List<CompletableFuture<Long>> executeBulkAction(
        ...
        for (int bulkIdx = 0; bulkIdx < bulkParams.size(); bulkIdx++) {
            ...
            var grouper = buildGrouper.apply(assignmentSources);
            try {
    ...
    private <TReq extends ShardRequest<TReq, TItem>, TItem extends ShardRequest.Item> GroupRowsByShard<TReq, TItem> createRowsByShardGrouper(
        Supplier<String> indexNameResolver,
    ...
    private <TReq extends ShardRequest<TReq, TItem>, TItem extends ShardRequest.Item> CompletableFuture<ShardResponse.CompressedResult> executeAction(
        ...
        for (var request : shardUpsertRequests) {
    ...
    private static CompletableFuture<AcknowledgedResponse> createIndices(
